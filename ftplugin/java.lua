...
local workspace_dir = '/Users/houruxin/Documents/workspace/java/' .. project_name
...
local config = {
  ...
  cmd = {
    ...
    "-javaagent:/Users/houruxin/.config/nvim/lsp/jdt-language-server/lombok.jar",
    "-Xbootclasspath/a:/Users/houruxin/.config/nvim/lsp/jdt-language-server/lombok.jar",
    -- 💀
    -- '-jar', '/path/to/jdtls_install_location/plugins/org.eclipse.equinox.launcher_VERSION_NUMBER.jar',
    '-jar', '/Users/houruxin/.config/nvim/lsp/jdt-language-server/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar',
         -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    '-configuration', '/Users/houruxin/.config/nvim/lsp/jdt-language-server/config_mac',
                    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
    ...
    '-data', "/Users/houruxin/Documents/workspace/jdt_data",
  },
